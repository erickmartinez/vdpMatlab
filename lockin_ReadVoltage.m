function [leakage_current,V,V_err,phase,freq] ...
    = lockin_ReadVoltage(app,vg,repetitions,SRS_timeconstant)
    ...
    fprintf(app.handle_k2400,':SOUR:VOLT:LEV %.3E',vg); % Source output level
...
%         pause(SRS_timeconstant);
    ...
    fprintf(app.handle_k2400,':READ?'); % Trigger, acquire reading.
    leakage_current = str2double(fscanf(app.handle_k2400));
